...
public class RangoCincoEmbarazadasFragment extends Fragment {
    private View view;
    ...
    private static TextInputLayout il_semanas;
    ...
    public RangoCincoEmbarazadasFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rango_cinco_embarazadas, container, false);
        il_estatura = view.findViewById(R.id.il_estatura);
        il_ganancia_peso = view.findViewById(R.id.il_gananciaPeso3);
        il_cbi = view.findViewById(R.id.il_cbi);
        il_semanas = view.findViewById(R.id.il_semanas_2);
        et_ganancia_peso = view.findViewById(R.id.et_gananciaPeso3);
        et_semanas = view.findViewById(R.id.et_semanas_2);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //context = (Context) bundle.getSerializable("context");
